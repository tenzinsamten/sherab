...
2. Account starts **Pending**: not active, not visible on any roster or leaderboard, cannot log progress.
3. Registration includes a consent step (parental/guardian consent for a minor's data being processed) before it goes to the teacher for approval.
4. Any teacher assigned to that class can approve/reject the pending registration.
